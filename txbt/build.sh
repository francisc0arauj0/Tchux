...
if [ -z "$2" ]; then
	...
	echo "Use:"
	echo "$0 $TARGET /home/your_user/Tchux/txbt/cross-compiler\n"
	exit 1
fi
...
echo "============================"
echo "${C_LIME}TxBT installed!\n${NO_FORMAT}"
echo "Local: $PREFIX\n"
echo "Verification:"
echo "txbt/cross-compiler/bin/$TARGET-ld --version"
echo "txbt/cross-compiler/bin/$TARGET-gcc --version"
echo "txbt/cross-compiler/bin/$TARGET-gdb --version"
echo "============================"